...
public abstract class ArabianCoCrudAppServiceBase<TEntity, TEntityDto, TPrimaryKey, TLiteEntityDto, TGetAllInput, TCreateInput, TUpdateInput>
  : ApplicationService
  ...
  where TUpdateInput : IEntityDto<TPrimaryKey>
{
    ...
    protected ArabianCoCrudAppServiceBase(IRepository<TEntity, TPrimaryKey> repository)
    {
