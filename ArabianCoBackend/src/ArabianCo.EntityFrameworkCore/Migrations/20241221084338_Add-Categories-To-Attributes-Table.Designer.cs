...
namespace ArabianCo.Migrations
{
    ...
    [Migration("20241221084338_Add-Categories-To-Attributes-Table")]
    partial class AddCategoriesToAttributesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArabianCo.Domain.MaintenanceRequests.MaintenanceRequest", b =>
                {
                    ...
                    b.Property<bool>("IsInWarrantyPeriod")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ArabianCo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ArabianCo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ArabianCo.Domain.AboutUss.AboutUsTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.AboutUss.AboutUs", "Core")
            ...
            modelBuilder.Entity("ArabianCo.Domain.AttributeValues.AttributeValue", b =>
                {
                    b.HasOne("ArabianCo.Domain.Attributes.Attribute", "Attribute")
                        .WithMany()
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArabianCo.Domain.Products.Product", "Product")
            ...
            modelBuilder.Entity("ArabianCo.Domain.AttributeValues.AttributeValueTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.AttributeValues.AttributeValue", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArabianCo.Domain.Brands.BrandTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.Brands.Brand", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArabianCo.Domain.Categories.Category", b =>
                {
                    b.HasOne("ArabianCo.Domain.Categories.Category", "ParentCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("ArabianCo.Domain.Categories.CategoryTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.Categories.Category", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArabianCo.Domain.Cities.City", b =>
                {
                    b.HasOne("ArabianCo.Domain.Countries.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("ArabianCo.Domain.Cities.CityTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.Cities.City", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArabianCo.Domain.Countries.CountryTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.Countries.Country", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArabianCo.Domain.FrequentlyQuestions.FrequentlyQuestionTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.FrequentlyQuestions.FrequentlyQuestion", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArabianCo.Domain.Products.ProductTranslation", b =>
                {
                    b.HasOne("ArabianCo.Domain.Products.Product", "Core")
                        .WithMany("Translations")
                        .HasForeignKey("CoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
